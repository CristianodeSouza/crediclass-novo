...
FIELD_ALIASES = {
    ...
    "indexador": ["indexador"],
    "taxa_adm": ["taxa administracao", "taxa adm", "taxa adm total", "taxa adm original", "taxa de administracao", "taxa administrativa", "tx adm", "tx administracao"],
    ...
    "prazo_restante": ["prazo restante", "prazo remanescente"],
