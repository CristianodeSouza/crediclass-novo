...
const businessRulesFlow = [
  ...
  },
  {
    ...
    regras: [
      ...
      "Agressivo (1 a 3 meses): o sistema pega os menores lances dos ultimos 3 meses com contemplacao, exige pelo menos 2 meses contemplados e usa a maior referencia desse periodo + 0,25 ponto percentual. O resultado precisa ficar em 50% ou mais. Exemplo: menores lances 50% e 52%; referencia = 52,25%; perfil Agressivo atendido.",
      "Moderado (4 a 6 meses): o sistema pega os menores lances dos ultimos 6 meses com contemplacao, exige pelo menos 2 meses contemplados e usa o segundo menor lance + 0,25 ponto percentual. O resultado precisa ficar entre 40% e 50%. Exemplo: menores lances 41%, 43% e 48%; segundo menor = 43%; referencia = 43,25%; perfil Moderado atendido.",
      "Conservador (7 a 12 meses): o sistema pega os menores lances dos ultimos 12 meses com contemplacao, exige pelo menos 2 meses contemplados e usa o segundo menor lance + 0,25 ponto percentual. O resultado precisa ficar entre 30% e 40%. Exemplo: menores lances 31%, 34% e 38%; referencia = 34,25%; perfil Conservador atendido.",
      "Super Conservador (13 a 24 meses): o sistema pega os menores lances dos ultimos 12 meses com contemplacao, exige pelo menos 2 meses contemplados e usa o segundo menor lance + 0,25 ponto percentual. O resultado precisa ficar entre 20% e 30%. Exemplo: menores lances 22%, 25% e 29%; referencia = 25,25%; perfil Super Conservador atendido.",
      "Investidor (sem urgencia): o sistema usa o lance fixo cadastrado no grupo ou 0 quando nao houver lance fixo. O resultado fica limitado entre 0% e 20%. Exemplo: lance fixo cadastrado de 12%; referencia = 12%; perfil Investidor atendido.",
    ],
  },
  {
    id: "estrategias",
