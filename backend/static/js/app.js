...
function financialStudyGroupCard(item, assemblyData, generatedAt, assemblyError = "") {
  ...
  return `<article class="financial-study-group-card">
    ...
    <div class="financial-study-group-assembly"><div class="financial-study-group-section-title"><strong>Agenda de assembleia do grupo</strong><span>Datas futuras vinculadas à administradora e ao vencimento da parcela</span></div>${financialStudyGroupAssemblyBlock(item, assemblyData, generatedAt, assemblyError)}</div>
  </article>`;
}
