...
class StaticEmailTest(unittest.TestCase):
    ...
    def test_index_referencia_app_js_atualizado(self):
        ...
        self.assertIn("/static/css/style.css?v=4.0.23", index_html)
        ...
        self.assertIn("/static/js/app.js?v=4.0.23", index_html)
    ...
    def test_estudo_financeiro_expoe_resumo_executivo_e_rastreabilidade(self):
        ...
        self.assertIn("Destaque da seleção atual", app_js)
