...
class StaticEmailTest(unittest.TestCase):
    ...
    def test_index_referencia_app_js_atualizado(self):
        ...
        self.assertIn("/static/css/style.css?v=4.0.88", index_html)
        ...
        self.assertIn("/static/js/app.js?v=4.0.88", index_html)
        self.assertIn("/static/js/api.js?v=4.0.88", index_html)
