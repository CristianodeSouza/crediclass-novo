...
def history(values):
    return {
        f"2026-{index:02d}": {"menor_lance": value}
...
class LanceReferenceEngineTest(unittest.TestCase):
    ...
    def test_second_lowest_uses_latest_valid_months_and_adds_increment(self):
        ...
        historico["2025-12"] = {"menor_lance": 0.01}
        historico["invalido"] = {"menor_lance": 0.02}
    ...
    def test_history_shortage_returns_none(self):
        ...
        self.assertIsNone(aggressive_reference(history([0.30, 0.31])))
